 ...
 */
class PurchaseDraftRevalidatorTests {
    ...
    void acceptsUnchangedTrainWithEnoughSeats() {
        ...
        when(ticketTool.call(any(String.class), any(ToolContext.class))).thenReturn("""
                ...
                """);
        PurchaseDraftRevalidator service = service(stationTool, ticketTool);
     ...
     */
    @SuppressWarnings("unchecked")
    private PurchaseDraftRevalidator service(ToolCallback... callbacks) {
        ...
        return new PurchaseDraftRevalidator(
                providers,
