 ...
 */
class TicketOperationChainServiceTests {
    ...
    void cancellationResolvesOrderBeforeCreatingDraft() {
        ...
        TicketOperationChainService service = service(
        ...
        TicketOperationChainService.OperationChainResult result = service.executeCancellation(
    ...
    void refundResolvesTicketsBeforeCreatingDraft() {
        ...
        TicketOperationChainService.OperationChainResult result = service.executeRefund(
     ...
     * @return 待验证的固定交易代码链
     */
    private TicketOperationChainService service(
        ...
        return new TicketOperationChainService(
                cancellationTools,
                refundTools,
                draftTools,
