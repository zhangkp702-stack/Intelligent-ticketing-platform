...
import org.opengoofy.index12306.ai.agentservice.action.dto.PurchaseActionModels.PurchaseExecutionResult;
...
import static org.opengoofy.index12306.ai.agentservice.action.observability.AgentActionMetrics.ConfirmationRejection.INVALID_TOKEN;
import static org.opengoofy.index12306.ai.agentservice.action.observability.AgentActionMetrics.ConfirmationRejection.NOT_CONFIRMABLE;
 ...
 */
@Service
public class PurchaseActionServiceImpl implements PurchaseActionService {

    private static final Logger LOGGER = LoggerFactory.getLogger(PurchaseActionServiceImpl.class);
    ...
    private final PurchaseDraftRevalidator purchaseDraftRevalidator;
     ...
     * @param purchaseDraftRevalidator 购票确认前最新余票核验器
    ...
    public PurchaseActionServiceImpl(
            ...
            PurchaseDraftRevalidator purchaseDraftRevalidator,
        ...
        this.purchaseDraftRevalidator = purchaseDraftRevalidator;
    ...
    public ActionStatusView confirm(ConfirmPurchaseCommand command) {
        ...
        try {
            if (current.getActionType() == AgentActionType.TICKET_PURCHASE) {
                ...
                purchaseDraftRevalidator.revalidate(
